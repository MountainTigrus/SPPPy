...
https://disk.yandex.ru/d/ApCZ9icRkd-Jng
...
Далее кладём их в папку *SPPPy*, перемещаем полученную папку в папку с Вашим проектом и работаем!
...
## 3. Слой с дисперсией по длине волны.
...
<ins>**Рис 4.** Зависимость комплексного коэффициента преломления для золота.</ins>
...
## 4. Работа с базой веществ через MaterialDispersion.
