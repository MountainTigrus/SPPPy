...
material.wp = 0.3e15
```
Однако, если в примере сверху в исходном случае было несколько слоёв, а мы, вместо массива пославили одно значение типа _float_, то программа выдаст ошибку. И обратно, если был один тип электронов, а мы вписали массив, то программа работать не будет.
